      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-6">
        <header className="glass rounded-[32px] p-8 shadow-2xl shadow-black/30">
          ...
          <p className="mt-4 max-w-3xl text-sm leading-6 text-zinc-400 md:text-base">
            The model blends recent form, historical track performance, teammate-relative strength, DNF risk,
            and live weather context to rank the field for {prediction.target.eventName}.
          </p>
        </header>
